...
- Original required: SnapAI CLI, OpenAI API key (~$0.04/icon)
- Modified to support: ComfyUI (local/free), Gemini, Grok, or prompt-only fallback

## Related ADRs
- [067. App Icon Multi-Backend Architecture](../../doc/decisions/067-app-icon-multi-backend-architecture.md)
